...
const Feature = () => {
  return (
    <>
      <motion.div initial={{ opacity: 0, y: -50}} whileInView={{ opacity: 1, y: 0}} transition={{ duration: 0.8, ease: 'easeOut'}} viewport={{ once: true, amount: 0.4}} className="h-auto m-10 grid grid-cols-auto gap-10 text-black">
        ...
        <div className="flex flex-row mt-16 gap-8">
            ...
            <motion.div initial={{ opacity: 0, x: -50}} whileInView={{ opacity: 1, x: 0}} transition={{ duration: 0.8, ease: 'easeOut'}} viewport={{ once: true, amount: 0.4 }} className="py-4 px-6 bg-[#FFA673] shadow-2xl rounded-xl">
            ...
            <motion.div initial={{ opacity: 0, x: 50}} whileInView={{ opacity: 1, x: 0}} transition={{ duration: 0.8, ease: 'easeOut'}} viewport={{ once: true, amount: 0.4}}  className="py-4 px-4 bg-[#FFA673] shadow-2xl rounded-xl">
        ...
        <div className="flex flex-row justify-center"> 
            ...
            <div className="py-4 px-6 md:py-6 bg-[#FFA673] shadow-2xl rounded-xl w-[60%]">
